...
export default function AjanKonseyi() {
  ...
  return (
    <div className="module-transition space-y-5">
      <div>
        ...
        <h1 className="mihenk-module-title flex items-center gap-2"><Shield className="w-6 h-6 text-[hsl(var(--mihenk-blue))]" /> Ajan Konseyi</h1>
        <p className="text-sm text-muted-foreground mt-1">Uzman ajanların rol bazlı çalışması</p>
      </div>
      ...
      <div className="mihenk-card p-6 text-center py-12 text-muted-foreground">
        ...
        <p className="text-sm">Ajan Konseyi modülü hazırlanıyor</p>
      </div>
    </div>
  );
}
